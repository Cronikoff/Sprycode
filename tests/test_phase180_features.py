"""Phase 180: Report-level stateGainAttributionResidualAbsolutePerTarget metric.

stateGainAttributionResidualAbsolutePerTarget =
    stateGainAttributionResidualAbsolute / len(targets)
...
class TestPathwayStateGainAttributionResidualAbsolutePerTarget:
    def test_single_target_matches_formula(self):
        ...
        if absolute is None or target_count == 0:
            assert rep["stateGainAttributionResidualAbsolutePerTarget"] is None
        else:
            expected = absolute / target_count
            assert abs(rep["stateGainAttributionResidualAbsolutePerTarget"] - expected) < 1e-9
