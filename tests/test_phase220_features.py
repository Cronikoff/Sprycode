"""Phase 220: Report-level stateGainAttributionCoverageResidualCoverageAbsoluteCoveragePerTarget metric."""
...
class TestPathwayStateGainAttributionCoverageResidualCoverageAbsoluteCoveragePerTarget:
    def test_single_target_matches_formula(self):
        ...
        if coverage is None or count == 0:
            assert rep["stateGainAttributionCoverageResidualCoverageAbsoluteCoveragePerTarget"] is None
        else:
            expected = coverage / count
            assert abs(rep["stateGainAttributionCoverageResidualCoverageAbsoluteCoveragePerTarget"] - expected) < 1e-9
