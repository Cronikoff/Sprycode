"""Phase 276: Report-level stateGainAttributionCoverageAbsoluteResidual metric."""
...
class TestPhase276:
    def test_single_target_matches_formula(self):
        ...
        if residual is None:
            ...
            assert abs(rep["stateGainAttributionCoverageAbsoluteResidual"] - abs(residual)) < 1e-9
