"""Phase 230: Report-level stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoveragePerCycle metric."""
...
class TestPathwayStateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoveragePerCycle:
    def test_single_target_matches_formula(self):
        ...
        if coverage is None or cycles == 0:
            assert rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoveragePerCycle"] is None
        else:
            expected = coverage / cycles
            assert abs(rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoveragePerCycle"] - expected) < 1e-9
