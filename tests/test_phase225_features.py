"""Phase 225: Report-level stateGainAttributionCoverageResidualAbsoluteCoverageAbsolute metric.

stateGainAttributionCoverageResidualAbsoluteCoverageAbsolute =
    abs(stateGainAttributionCoverageResidualAbsoluteCoverage)
...
class TestPathwayStateGainAttributionCoverageResidualAbsoluteCoverageAbsolute:
    def test_single_target_matches_formula(self):
        ...
        if coverage is None:
            assert rep["stateGainAttributionCoverageResidualAbsoluteCoverageAbsolute"] is None
        else:
            expected = abs(coverage)
            assert abs(rep["stateGainAttributionCoverageResidualAbsoluteCoverageAbsolute"] - expected) < 1e-9
