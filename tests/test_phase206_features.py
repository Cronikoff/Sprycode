"""Phase 206: Report-level stateGainAttributionCoverageAbsoluteResidualCoverageAbsolutePerCycle metric."""
...
class TestPathwayStateGainAttributionCoverageAbsoluteResidualCoverageAbsolutePerCycle:
    def test_single_target_matches_formula(self):
        ...
        if absolute is None or cycles == 0:
            assert rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsolutePerCycle"] is None
        else:
            expected = absolute / cycles
            assert abs(rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsolutePerCycle"] - expected) < 1e-9
