"""Phase 222: Report-level stateGainAttributionCoverageResidualCoverageAbsoluteCoverageAbsolutePerCycle metric."""
...
class TestPathwayStateGainAttributionCoverageResidualCoverageAbsoluteCoverageAbsolutePerCycle:
    def test_single_target_matches_formula(self):
        ...
        if absolute is None or cycles == 0:
            assert rep["stateGainAttributionCoverageResidualCoverageAbsoluteCoverageAbsolutePerCycle"] is None
        else:
            expected = absolute / cycles
            assert abs(rep["stateGainAttributionCoverageResidualCoverageAbsoluteCoverageAbsolutePerCycle"] - expected) < 1e-9
