"""Phase 223: Report-level stateGainAttributionCoverageResidualCoverageAbsoluteCoverageAbsolutePerAttempt metric."""
...
class TestPathwayStateGainAttributionCoverageResidualCoverageAbsoluteCoverageAbsolutePerAttempt:
    def test_single_target_matches_formula(self):
        ...
        if absolute is None or attempts == 0:
            assert rep["stateGainAttributionCoverageResidualCoverageAbsoluteCoverageAbsolutePerAttempt"] is None
        else:
            expected = absolute / attempts
            assert abs(rep["stateGainAttributionCoverageResidualCoverageAbsoluteCoverageAbsolutePerAttempt"] - expected) < 1e-9
