"""Phase 278: Report-level stateGainAttributionCoverageAbsoluteResidualPerAttempt metric."""
...
class TestPhase278:
    def test_single_target_matches_formula(self):
        ...
        if base is None or attempts == 0:
            ...
            assert abs(rep["stateGainAttributionCoverageAbsoluteResidualPerAttempt"] - (base / attempts)) < 1e-9
