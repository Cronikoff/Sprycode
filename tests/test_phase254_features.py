"""Phase 254: Report-level stateGainAttributionCoverageResidualAbsoluteCoverageAbsoluteCoveragePerCycle metric."""
...
class TestPhase254CoverageResidualAbsoluteCoverageAbsoluteCoveragePerCycle:
    def test_single_target_matches_formula(self):
        ...
        if base is None or cycles == 0:
            assert rep["stateGainAttributionCoverageResidualAbsoluteCoverageAbsoluteCoveragePerCycle"] is None
        else:
            expected = base / cycles
            assert abs(rep["stateGainAttributionCoverageResidualAbsoluteCoverageAbsoluteCoveragePerCycle"] - expected) < 1e-9
