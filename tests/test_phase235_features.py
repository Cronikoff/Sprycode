"""Phase 235: Report-level stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsolutePerAttempt metric."""
...
class TestPathwayStateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsolutePerAttempt:
    def test_single_target_matches_formula(self):
        ...
        if absolute is None or attempts == 0:
            assert rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsolutePerAttempt"] is None
        else:
            expected = absolute / attempts
            assert abs(rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsolutePerAttempt"] - expected) < 1e-9
