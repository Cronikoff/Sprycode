"""Phase 208: Report-level stateGainAttributionCoverageAbsoluteResidualCoverageAbsolutePerTarget metric."""
...
class TestPathwayStateGainAttributionCoverageAbsoluteResidualCoverageAbsolutePerTarget:
    def test_single_target_matches_formula(self):
        ...
        if absolute is None or count == 0:
            assert rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsolutePerTarget"] is None
        else:
            expected = absolute / count
            assert abs(rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsolutePerTarget"] - expected) < 1e-9
