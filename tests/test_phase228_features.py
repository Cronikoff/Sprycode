"""Phase 228: Report-level stateGainAttributionCoverageResidualAbsoluteCoverageAbsolutePerTarget metric."""
...
class TestPathwayStateGainAttributionCoverageResidualAbsoluteCoverageAbsolutePerTarget:
    def test_single_target_matches_formula(self):
        ...
        if absolute is None or count == 0:
            assert rep["stateGainAttributionCoverageResidualAbsoluteCoverageAbsolutePerTarget"] is None
        else:
            expected = absolute / count
            assert abs(rep["stateGainAttributionCoverageResidualAbsoluteCoverageAbsolutePerTarget"] - expected) < 1e-9
