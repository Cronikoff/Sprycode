"""Phase 256: Report-level stateGainAttributionCoverageResidualAbsoluteCoverageAbsoluteCoveragePerTarget metric."""
...
class TestPhase256CoverageResidualAbsoluteCoverageAbsoluteCoveragePerTarget:
    def test_single_target_matches_formula(self):
        ...
        if base is None or count == 0:
            assert rep["stateGainAttributionCoverageResidualAbsoluteCoverageAbsoluteCoveragePerTarget"] is None
        else:
            expected = base / count
            assert abs(rep["stateGainAttributionCoverageResidualAbsoluteCoverageAbsoluteCoveragePerTarget"] - expected) < 1e-9
