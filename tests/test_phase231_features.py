"""Phase 231: Report-level stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoveragePerAttempt metric."""
...
class TestPathwayStateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoveragePerAttempt:
    def test_single_target_matches_formula(self):
        ...
        if coverage is None or attempts == 0:
            assert rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoveragePerAttempt"] is None
        else:
            expected = coverage / attempts
            assert abs(rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoveragePerAttempt"] - expected) < 1e-9
