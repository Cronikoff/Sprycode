"""Phase 202: Report-level stateGainAttributionCoverageResidualCoverageAbsolutePerCycle metric.

stateGainAttributionCoverageResidualCoverageAbsolutePerCycle =
    stateGainAttributionCoverageResidualCoverageAbsolute / cycles
...
class TestPathwayStateGainAttributionCoverageResidualCoverageAbsolutePerCycle:
    def test_single_target_matches_formula(self):
        ...
        if absolute is None or cycles == 0:
            assert rep["stateGainAttributionCoverageResidualCoverageAbsolutePerCycle"] is None
        else:
            expected = absolute / cycles
            assert abs(rep["stateGainAttributionCoverageResidualCoverageAbsolutePerCycle"] - expected) < 1e-9
