"""Phase 140: Report-level spry summary meaning from average spry score."""
...
class TestPathwayReportSprySummaryMeaning:
    def test_summary_meaning_vigorous(self):
        i = run("""
        ...
        """)
        assert val(i, "m") == "vigorous"

    def test_summary_meaning_brisk(self):
        i = run("""
            let orch = Orchestrator.new()
            orch.addManagedStep(
                "svc",
            ...
            let m = rep["sprySummaryMeaning"]
        """)
        assert val(i, "m") == "brisk"

    def test_summary_meaning_active(self):
        i = run("""
            let orch = Orchestrator.new()
            orch.addManagedStep(
                "svc",
            ...
            let m = rep["sprySummaryMeaning"]
        """)
        assert val(i, "m") == "active"

    def test_summary_meaning_lively(self):
        i = run("""
            let orch = Orchestrator.new()
            orch.addManagedStep(
                "svc",
            ...
            let m = rep["sprySummaryMeaning"]
        """)
        assert val(i, "m") == "lively"

    def test_summary_meaning_none_without_managed_targets(self):
        i = run("""
            let orch = Orchestrator.new()
