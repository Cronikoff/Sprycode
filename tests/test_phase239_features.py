"""Phase 239: Report-level stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsoluteCoveragePerAttempt metric."""
...
class TestPathwayStateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsoluteCoveragePerAttempt:
    def test_single_target_matches_formula(self):
        ...
        if coverage is None or attempts == 0:
            assert rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsoluteCoveragePerAttempt"] is None
        else:
            expected = coverage / attempts
            assert abs(rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsoluteCoveragePerAttempt"] - expected) < 1e-9
