"""Phase 273: Report-level stateGainAttributionResidualCoverage metric."""
...
class TestPhase273:
    def test_single_target_matches_formula(self):
        ...
        if residual is None or rg is None or rg == 0:
            assert rep["stateGainAttributionResidualCoverage"] is None
        else:
            assert abs(rep["stateGainAttributionResidualCoverage"] - (residual / rg)) < 1e-9
