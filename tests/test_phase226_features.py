"""Phase 226: Report-level stateGainAttributionCoverageResidualAbsoluteCoverageAbsolutePerCycle metric."""
...
class TestPathwayStateGainAttributionCoverageResidualAbsoluteCoverageAbsolutePerCycle:
    def test_single_target_matches_formula(self):
        ...
        if absolute is None or cycles == 0:
            assert rep["stateGainAttributionCoverageResidualAbsoluteCoverageAbsolutePerCycle"] is None
        else:
            expected = absolute / cycles
            assert abs(rep["stateGainAttributionCoverageResidualAbsoluteCoverageAbsolutePerCycle"] - expected) < 1e-9
