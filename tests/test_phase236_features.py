"""Phase 236: Report-level stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsolutePerTarget metric."""
...
class TestPathwayStateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsolutePerTarget:
    def test_single_target_matches_formula(self):
        ...
        if absolute is None or count == 0:
            assert rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsolutePerTarget"] is None
        else:
            expected = absolute / count
            assert abs(rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsolutePerTarget"] - expected) < 1e-9
