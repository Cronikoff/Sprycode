"""Phase 238: Report-level stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsoluteCoveragePerCycle metric."""
...
class TestPathwayStateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsoluteCoveragePerCycle:
    def test_single_target_matches_formula(self):
        ...
        if coverage is None or cycles == 0:
            assert rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsoluteCoveragePerCycle"] is None
        else:
            expected = coverage / cycles
            assert abs(rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsoluteCoverageAbsoluteCoveragePerCycle"] - expected) < 1e-9
