"""Phase 176: Report-level stateGainAttributionResidualCoverageAbsolutePerTarget metric.

stateGainAttributionResidualCoverageAbsolutePerTarget =
    stateGainAttributionResidualCoverageAbsolute / len(targets)
(when target count > 0 and the absolute residual coverage is numeric)
"""
...
class TestPathwayStateGainAttributionResidualCoverageAbsolutePerTarget:
