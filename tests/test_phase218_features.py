"""Phase 218: Report-level stateGainAttributionCoverageResidualCoverageAbsoluteCoveragePerCycle metric."""
...
class TestPathwayStateGainAttributionCoverageResidualCoverageAbsoluteCoveragePerCycle:
    def test_single_target_matches_formula(self):
        ...
        if coverage is None or cycles == 0:
            assert rep["stateGainAttributionCoverageResidualCoverageAbsoluteCoveragePerCycle"] is None
        else:
            expected = coverage / cycles
            assert abs(rep["stateGainAttributionCoverageResidualCoverageAbsoluteCoveragePerCycle"] - expected) < 1e-9
