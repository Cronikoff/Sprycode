"""Phase 207: Report-level stateGainAttributionCoverageAbsoluteResidualCoverageAbsolutePerAttempt metric."""
...
class TestPathwayStateGainAttributionCoverageAbsoluteResidualCoverageAbsolutePerAttempt:
    def test_single_target_matches_formula(self):
        ...
        if absolute is None or attempts == 0:
            assert rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsolutePerAttempt"] is None
        else:
            expected = absolute / attempts
            assert abs(rep["stateGainAttributionCoverageAbsoluteResidualCoverageAbsolutePerAttempt"] - expected) < 1e-9
